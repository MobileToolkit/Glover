...
//! Project version number for Glover.
FOUNDATION_EXPORT double GloverVersionNumber;

//! Project version string for Glover.
FOUNDATION_EXPORT const unsigned char GloverVersionString[];
